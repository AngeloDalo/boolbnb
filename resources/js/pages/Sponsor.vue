                ...
                <div class="container row" v-if="apartments.length != 0">
                        <div class="div col-3 me-2 border-danger border" v-for="apartment in apartments" :key="apartment.id">
                            ...
                            <div class="card-body">
                                ...
                                <span class="p-sponsor"><span class="span-sponsor">Beds:</span>{{ apartment.rooms }}</span>
                                <span class="p-sponsor">Beds: {{ apartment.beds }}</span>
                                <span class="p-sponsor"><span class="span-sponsor">Bathrooms:</span>{{ apartment.bathrooms }}</span>
                                <span class="p-sponsor"><span class="span-sponsor">Square:</span>{{ apartment.square }}</span>
                                <div>
                                    <router-link
