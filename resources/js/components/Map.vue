  ...
  methods: {
      ...
      Axios.get(url)
        .then((result) => {
          ...
          this.apartments.forEach((apartment) => {
            let llApartment = new tt.LngLat(apartment.longitude, apartment.latitude);
    ...
    handleResults: function (result) {
      if (result.results) {
        ...
        this.moveMap(lnglat);
        let llSearching = new tt.LngLat(this.position.lng, this.position.lat);

        // cicliamo sugli appartementi
        this.apartments.forEach((apartment) => {
          let apartamentLat = apartment.latitude;
          let apartamentLng = apartment.longitude;
          let llApartment = new tt.LngLat(apartamentLng, apartamentLat);
