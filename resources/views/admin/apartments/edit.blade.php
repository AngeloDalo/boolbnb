                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text-area" class="form-control" id="bathrooms" name="bathrooms"
                                    row="5">{{ $apartment->bathrooms }}</textarea>
                            </div>
                            <p id="demo5"></p>
                            @error('beds')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text-area" class="form-control" id="square" name="square"
                                    row="5">{{ $apartment->square }}</textarea>
                            </div>
                            <p id="demo6"></p>
                            @error('square')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text-area" class="form-control" id="address" name="address"
                                    row="5">{{ $apartment->address }}</textarea>
                            </div>
                            <p id="demo7"></p>
                            @error('address')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text-area" class="form-control" id="latitude" name="latitude"
                                    row="5">{{ $apartment->latitude }}</textarea>
                            </div>
                            <p id="demo8"></p>
                            @error('latitude')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea type="text-area" class="form-control" id="longitude" name="longitude"
                                    row="5">{{ $apartment->longitude }}</textarea>
                            </div>
                            <p id="demo9"></p>
                            @error('longitude')
                                <div class="alert alert-danger">{{ $message }}</div>
